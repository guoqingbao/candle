...
impl Storage {
    ...
    pub(crate) fn inplace_op1(&mut self, l: &Layout, c: &dyn InplaceOp1) -> Result<()> {
        match self {
            ...
            Self::Gcu(storage) => c.gcu_fwd(storage, l),
    ...
    pub(crate) fn inplace_op2(
        ...
        match (self, t2) {
            ...
            (Self::Gcu(s1), Self::Gcu(s2)) => c.gcu_fwd(s1, l1, s2, l2),
    ...
    pub(crate) fn inplace_op3(
        ...
        match (self, t2, t3) {
            ...
            (Self::Gcu(s1), Self::Gcu(s2), Self::Gcu(s3)) => c.gcu_fwd(s1, l1, s2, l2, s3, l3),
            (Self::Metal(s1), Self::Metal(s2), Self::Metal(s3)) => {
